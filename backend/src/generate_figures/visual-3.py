...
data = {
    'Overall Satisfaction': [4, 5, 4, 4, 5, 5, 4],
    'Original or Mixed': [5, 4, 3, 5, 5, 5, 3],
    'Instrument Selection': [5, 4, 3, 5, 5, 5, 3],
    'Music Style Satisfaction': [5, 5, 5, 5, 5, 4, 3]
}
...
plt.suptitle('Audio Panel Metrics', fontsize=20)
