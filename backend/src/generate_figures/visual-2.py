...
data = {
    'Overall Satisfaction': [4, 5, 4, 5, 5, 5, 4],
    'Helpfulness for Meditation': [4, 5, 4, 4, 3, 3, 3],
    'Status Correspondence': [2, 3, 4, 3, 5, 3, 3]
}
...
plt.suptitle('Image & Test Panel Metrics', fontsize=20)
