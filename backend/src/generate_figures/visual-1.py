...
data = {
    'Overall Satisfaction': [5, 4, 5, 5, 5, 5, 4],
    'Helpfulness for Meditation': [4, 3, 3, 4, 3, 4, 4],
    'Ease of Capturing Device Status': [4, 4, 5, 4, 5, 4, 4]
}
...
plt.suptitle('Information Interface Metrics', fontsize=20)
